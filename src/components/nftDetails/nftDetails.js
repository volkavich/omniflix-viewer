          ...
          {data.map((record) => (
            <div>
              <div className="right-details-div">
                ...
                <p>
                  <b>Transferable: </b>
                  {record.nft.transferable ? "True" : "False"}
                </p>
                <p>
                  <b>Owner: </b>
                  {record.nft.owner}
                ...
                <p>
                  <b>Media_URI: </b>{" "}
                  <a
                    href={record.nft.media_uri}
                    rel="noreferrer"
                    target="_blank"
                    className="a-link"
                  >
                    {" "}
                    {record.nft.media_uri}{" "}
                  </a>
                </p>
                <p>
                  <b>Denom Symbol: </b>
                ...
                <p>
                  <b>Fiat Price in USD: </b>
                  {record.fiat_price.usd} USD /-
                </p>
                <p>
                  <b>Fiat Price in INR: </b>
                  {record.fiat_price.inr} INR /-
                </p>
              </div>
            </div>
          ))}
